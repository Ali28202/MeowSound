...
export default function Navbar() {
	return (
		<>
			<div className="flex z-10 fixed justify-between right-0 items-center px-10 gap-5 w-[79vw] h-20 bg-[#0D0D0D] rounded-2xl rounded-tr-none rounded-br-none rounded-tl-none">
